import { FaFacebook, FaGithub, FaMoon, FaSun, FaWhatsapp } from "react-icons/fa";
...
const Header = ({ theme, toggleTheme }: HeaderProps) => {
  return (
    <header
      className="bg-light-container-color dark:bg-dark-container-color border-[2px] border-light-border-color dark:border-dark-border-color py-8 px-5 rounded-lg w-full"
    >
      ...
      <div className="social-media flex items-center justify-center gap-4">
        ...
        >
          ...
          >
            <FaWhatsapp className="text-black dark:text-white w-[30px] h-[30px] hover:text-primary-color transition-all" />
          </a>
        </div>
        <div
        ...
        >
          ...
          >
            <FaGithub className="text-black dark:text-white w-[30px] h-[30px] hover:text-primary-color transition-all" />
          </a>
        </div>
        <div
        ...
        >
          ...
          >
            <FaFacebook className="text-black dark:text-white w-[30px] h-[30px] hover:text-primary-color transition-all" />
          </a>
        </div>
        <button
          onClick={toggleTheme}
          className="card theme-toggle bg-light-card-color dark:bg-dark-card-color p-3 rounded-lg shadow-card-shadow w-fit ml-4"
