			...
			<div className="content">
				...
				<section className="about mt-6" aria-labelledby="about-title">
					...
					<p className="text-lg text-black dark:text-white opacity-80 leading-loose">
						...
						باستخدام مكتبة React. شغفي يكمن في تحويل الأفكار إلى واجهات مستخدم
						سلسة وجذابة، تركز على تقديم تجربة استثنائية للمستخدمين. أمتلك خبرة
						في تصميم وتطوير مواقع متجاوبة وأنيقة، مع الحرص على تحقيق الأداء
						الأمثل والقابلية للتطوير.
					</p>
					<p className="text-lg text-black dark:text-white opacity-80 leading-loose mt-4">
						أتابع باستمرار أحدث التقنيات والاتجاهات في مجال تطوير الويب، مما
						يمكنني من تقديم حلول مبتكرة وعملية تلبي احتياجات العملاء. أستمتع
						بالعمل على تحديات جديدة والتعاون مع فرق متعددة التخصصات لإنجاز
						مشاريع تحقق تأثيرًا حقيقيًا. البرمجة بالنسبة لي ليست مجرد مهنة، بل
						وسيلة للإبداع وحل المشكلات.
					</p>
				</section>
					...
					>
						...
						>
							...
							<p className="body text-[18px] text-black dark:text-white leading-loose">
								تطوير واجهات ويب حديثة تعمل بكفاءة على جميع الأجهزة، مع ضمان
						...
						>
							...
							<p className="body text-[18px] text-black dark:text-white leading-loose">
								بناء تطبيقات ويب ديناميكية وقابلة للتطوير باستخدام React، مع
								التركيز على الأداء والتصميم.
							</p>
						</div>
						<div
							className="card p-4 border-[2px] border-light-border-color dark:border-dark-border-color bg-light-card-color dark:bg-dark-card-color shadow-card-shadow rounded-lg"
